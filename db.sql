...
-- Insert data into RegistrationDetails
...
-- Insert updated customer names
INSERT INTO Customers (id, name, city, age) VALUES
(1, 'Michael Carter', 'New York', 30),
(2, 'Sophia Turner', 'Los Angeles', 25),
(3, 'Liam Cooper', 'Chicago', 35),
(4, 'Olivia Bennett', 'New York', 28),
(5, 'Noah Mitchell', 'Houston', 32),
(6, 'Emma Parker', 'Los Angeles', 40);
...
-- Query: Companies with more than one order
...
-- Join to display full registration info
SELECT
    rd.id_number,
    rd.first_name,
    rd.last_name,
